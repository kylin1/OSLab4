...
void out_string(CONSOLE* p_con, char* str, int* color,int debug);
int is_current_console(CONSOLE* p_con);
void clear_console(CONSOLE* p_con);
void select_console(int nr_console);
void out_char(CONSOLE* p_con, char ch, int color,int debug);
void out_string_no_color(CONSOLE* p_con, char* str,int debug);
void out_string_color(CONSOLE* p_con, char* str,int debug);
